...
?>
<div class="subscribe-news" id="sender-subscribe">
    <div class="container">
        <div class="subscribe-news__flex">
            ...
            <form id="bx_subscribe_subform_<?= $buttonId ?>" role="form" method="post"
                ...
                <input class="subscribe-news__field" type="email" name="SENDER_SUBSCRIBE_EMAIL"
                ...
                <? endif; ?>
                    ...
                    <button class="btn subscribe-news__button" id="bx_subscribe_btn_<?= $buttonId ?>">
                       <?= GetMessage("subscr_form_button") ?></button>
            ...
            <form id="bx_subscribe_subform_<?= $buttonId ?>" role="form" method="post"
                ...
                <input class="subscribe-news__field" type="email" name="SENDER_SUBSCRIBE_EMAIL" value=""
