    ...
    <div class="other-page search-page">
        ...
        <div class="content-body">
            <div class="container">
                ...
                ?>
<?
global $arColorFilter;
$arColorFilter['PROPERTY_ELEMENT']=$elementId;
?>
...
<?
//$APPLICATION->SetTitle($APPLICATION->GetPageProperty('TitleDetail'));